# ING Direct: o banco que disse não

Curso em áudio em 6 episódios. Roteiro-fonte do podcast — este arquivo é a única
fonte de verdade do texto narrado; `build_podcast.py` lê daqui.

Convenções: `## N — Título` abre um episódio. `[pausa]` vira silêncio na trilha.
...
E agora o fecho, que conecta com a Pergunta Um da semana: banco precisa de capital regulatório de uns oito por cento dos depósitos — os tais oitenta mil dólares para cada milhão. Oito por cento de três vírgula sete bilhões: uns trezentos milhões de capital da matriz. Trinta e dois milhões de lucro sobre trezentos de capital… onze por cento. A meta era doze. [pausa] A promessa da matriz não era chute. Era o modelo rodando em alavancagem máxima. Essa reconstrução é minha, direcional — mas é o tipo de conta que ninguém mais vai levar pronta.
